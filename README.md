...
> 目前狀態：規格定稿、尚未動工。權威製作規格見
> [`ClaudeCode_FHD_Precision_Platformer_SPEC.md`](./ClaudeCode_FHD_Precision_Platformer_SPEC.md)（v0.1.0 定稿，9 段全數拍板），
> 程式碼將依該文件第 9 段的 `v0.1.0 → v1.0.0` 里程碑依序實作。
